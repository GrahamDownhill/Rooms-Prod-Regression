...
WebUI.click(findTestObject('Page_MyCliniccom - Free video calling betwe_21efb8/a_For Clinics'))

WebUI.click(findTestObject('Object Repository/Page_For Clinics - MyCliniccom/a_Log In'))
